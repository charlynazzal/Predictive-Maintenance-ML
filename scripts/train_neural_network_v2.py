...
nn_model_path = os.path.join(config.MODELS_FOLDER, "optimized_nn_model.keras")
model.save(nn_model_path)

# ✅ Save training history
history_df = pd.DataFrame(history.history)
history_log_path = os.path.join(config.TRAINING_LOGS_FOLDER, "training_history.csv")
